...
public class PhpTemplate {
  public static String template(final String title, final String description, final String formContent) {
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t");
    _builder.append("else if (strpos($key, \'_other\') !== false) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("foreach ($value as $answer) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("if (strpos($answer, \'_other\') !== false) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t\t");
    _builder.append("echo \'<dd>\', $_POST[$answer], \'</dd>\';");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("else if (strpos($value, \'_other\') !== false) {");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t\t");
    _builder.append("echo \'<dd>\', $_POST[$value], \'</dd>\';");
    _builder.newLine();
    _builder.append("\t\t\t\t\t\t");
    _builder.append("}");
    _builder.newLine();
  ...
  public static CharSequence js() {
    ...
    _builder.newLine();
    _builder.newLine();
    _builder.append("$(\'.other-option\').focus(function() {");
    _builder.newLine();
    _builder.append("\t");
    _builder.append("$(this).siblings(\':radio, :checkbox\').attr(\'checked\', \'checked\');");
    _builder.newLine();
    _builder.append("});");
    _builder.newLine();
    _builder.newLine();
