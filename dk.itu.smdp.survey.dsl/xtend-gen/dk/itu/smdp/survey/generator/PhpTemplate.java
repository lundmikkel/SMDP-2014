...
public class PhpTemplate extends SurveyTemplate {
  ...
  public String template(final Survey survey, final String formContent) {
    ...
    _builder.newLine();
    _builder.append("\t    \t\t");
    _builder.append("if (mail($_POST[\'survey\'][\'to\'], $_POST[\'survey\'][\'subject\'], $message, $headers)) {");
    _builder.newLine();
    _builder.append("\t    \t\t\t");
    _builder.append("echo \'<div class=\"alert alert-success\">Mail successfully send :)</div>\';");
    _builder.newLine();
    _builder.append("\t    \t\t");
    _builder.append("}");
    _builder.newLine();
    ...
    _builder.newLine();
    _builder.append("\t    \t\t\t");
    _builder.append("echo \'<div class=\"alert alert-danger\">Mail was not send!</div>\';");
    _builder.newLine();
    _builder.append("\t    \t\t");
    _builder.append("}");
    _builder.newLine();
