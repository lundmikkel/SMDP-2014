...
public class TableImpl extends QuestionImpl implements Table {
	...
	public int eBaseStructuralFeatureID(int derivedFeatureID, Class<?> baseClass) {
		...
		if (baseClass == HasOther.class) {
			switch (derivedFeatureID) {
				case SurveyPackage.TABLE__OTHER: return SurveyPackage.HAS_OTHER__OTHER;
				case SurveyPackage.TABLE__OTHER_LABEL: return SurveyPackage.HAS_OTHER__OTHER_LABEL;
				default: return -1;
			}
		}
	...
	public int eDerivedStructuralFeatureID(int baseFeatureID, Class<?> baseClass) {
		...
		if (baseClass == HasOther.class) {
			switch (baseFeatureID) {
				case SurveyPackage.HAS_OTHER__OTHER: return SurveyPackage.TABLE__OTHER;
				case SurveyPackage.HAS_OTHER__OTHER_LABEL: return SurveyPackage.TABLE__OTHER_LABEL;
				default: return -1;
			}
		}
