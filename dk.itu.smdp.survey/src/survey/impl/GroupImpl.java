 ...
 * <ul>
 *   <li>{@link survey.impl.GroupImpl#getQuestions <em>Questions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class GroupImpl extends ItemImpl implements Group {
	...
	protected EClass eStaticClass() {
		return SurveyPackage.Literals.GROUP;
	}
	...
	public EList<Question> getQuestions() {
		if (questions == null) {
			questions = new EObjectContainmentEList<Question>(Question.class, this, SurveyPackage.GROUP__QUESTIONS);
		}
		return questions;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SurveyPackage.GROUP__QUESTIONS:
