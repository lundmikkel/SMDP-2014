...
public class SurveyFactoryImpl extends EFactoryImpl implements SurveyFactory {
	...
	public Object createFromString(EDataType eDataType, String initialValue) {
		switch (eDataType.getClassifierID()) {
			case SurveyPackage.DATE_MODE:
				return createDateModeFromString(eDataType, initialValue);
			default:
	...
	public String convertToString(EDataType eDataType, Object instanceValue) {
		switch (eDataType.getClassifierID()) {
			case SurveyPackage.DATE_MODE:
				return convertDateModeToString(eDataType, instanceValue);
			default:
				throw new IllegalArgumentException("The datatype '" + eDataType.getName() + "' is not a valid classifier");
		}
	}
	 ...
	 * @generated
	 */
	public DateMode createDateModeFromString(EDataType eDataType, String initialValue) {
		DateMode result = DateMode.get(initialValue);
	 ...
	 * @generated
	 */
	public String convertDateModeToString(EDataType eDataType, Object instanceValue) {
